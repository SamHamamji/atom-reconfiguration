...
static struct Grid *grid_1 = &(struct Grid){
    (struct Point[]){
        ...
        BOTH,   BOTH,   TARGET, SOURCE, SOURCE, SOURCE, SOURCE, EMPTY,  TARGET,
        BOTH,   BOTH,   BOTH,   BOTH,   BOTH,   EMPTY,  EMPTY,  SOURCE, EMPTY,
        SOURCE, TARGET, BOTH,   BOTH,   BOTH,   BOTH,   TARGET, SOURCE, SOURCE,
        SOURCE, SOURCE, SOURCE, BOTH,   TARGET, BOTH,   BOTH,   TARGET, TARGET,
        EMPTY,  SOURCE, SOURCE, EMPTY,  EMPTY,  TARGET, BOTH,   TARGET, BOTH,
        BOTH,   TARGET, SOURCE, EMPTY,  EMPTY,  SOURCE, SOURCE, BOTH,   BOTH,
        TARGET, BOTH,   TARGET, BOTH,   SOURCE, SOURCE, SOURCE, EMPTY,  SOURCE,
        TARGET, BOTH,   BOTH,   TARGET, BOTH,   TARGET, SOURCE, SOURCE, SOURCE,
        EMPTY,  EMPTY,  BOTH,   BOTH,   TARGET, BOTH,   TARGET, TARGET, SOURCE,
        EMPTY,  SOURCE, EMPTY,  SOURCE, BOTH,   TARGET, BOTH,   BOTH,   BOTH,
        TARGET, EMPTY,  SOURCE, SOURCE, EMPTY,  EMPTY,  BOTH,   TARGET, BOTH,
        BOTH,   TARGET, TARGET, EMPTY,  EMPTY,  EMPTY,  SOURCE, SOURCE, TARGET,
        BOTH,   TARGET, TARGET, TARGET, TARGET, SOURCE, SOURCE, SOURCE, SOURCE,
        SOURCE, TARGET, TARGET, TARGET, TARGET, TARGET, BOTH,   SOURCE, EMPTY,
        SOURCE, EMPTY,  EMPTY,  TARGET, TARGET, TARGET, TARGET, TARGET, TARGET,
        EMPTY,  EMPTY,  EMPTY,  SOURCE, SOURCE, TARGET, BOTH,   BOTH,   TARGET,
        BOTH,   TARGET, SOURCE, EMPTY,  SOURCE, SOURCE, EMPTY,  BOTH,   BOTH,
        TARGET, TARGET, TARGET, TARGET, SOURCE, SOURCE, EMPTY,  SOURCE, SOURCE,
        BOTH,   BOTH,   BOTH,   BOTH,   TARGET, BOTH,   SOURCE, SOURCE, EMPTY,
        SOURCE, EMPTY,  TARGET, BOTH,   BOTH,   TARGET, TARGET, BOTH,   EMPTY,
        SOURCE, SOURCE, SOURCE, EMPTY,  BOTH,   TARGET, BOTH,   BOTH,   BOTH,
        TARGET, EMPTY,  SOURCE, SOURCE, SOURCE, EMPTY,  TARGET, TARGET, TARGET,
